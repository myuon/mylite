...
var skipTests = map[string]bool{
	...
	// === sys_vars suite (failures re-added after test run) ===
		...
		"sys_vars/lock_order_basic":                                       true,
	...
	"perfschema/ddl_esms_by_program": true,
	"perfschema/ddl_prepared_statements_instances": true,
	"perfschema/dml_esms_by_program": true,
	"perfschema/dml_prepared_statements_instances": true,
	...
	"other/type_newdecimal_myisam": true,
