...
var skipTests = map[string]bool{
	...
	"json/json_no_table": true, // SHOW CREATE VIEW format mismatch with dolt expected output
	...
	// "perfschema/ddl_events_stages_current": true, // now passes
	// "perfschema/ddl_events_stages_history": true, // now passes
	...
	// "perfschema/idx_events_statements_history_long": true, // now passes
	"perfschema/idx_events_transactions_current": true,
	"perfschema/idx_events_transactions_history": true,
	// "perfschema/idx_events_transactions_history_long": true, // now passes
	"perfschema/idx_events_waits_current": true,
	"perfschema/idx_events_waits_history": true,
	// "perfschema/idx_events_waits_history_long": true, // now passes
	...
	// "perfschema/idx_keyring_keys": true, // now passes
	...
	// "perfschema/idx_performance_timers": true, // now passes
	...
	// "perfschema/idx_replication_group_member_stats": true, // now passes
	// "perfschema/idx_rwlock_instances": true, // now passes
	...
	// "perfschema/idx_variables_info": true, // now passes
	...
	// Multi-connection tests requiring connect/disconnect commands
	...
	// Requires charset/collation support
	...
	// Requires transaction detection for SET variable
	"sys_vars/binlog_checksum_basic": true,
	"sys_vars/pseudo_slave_mode_basic": true,
	// Requires access control / CREATE USER
	...
	// Requires PERSIST / RESET PERSIST
	...
	// Requires NULL for @@innodb_data_home_dir, @@mysqlx_ssl_*, etc
	...
	// Requires specific innodb defaults
	...
	// Requires sql_mode validation
	"sys_vars/sql_mode_basic": true,
	"sys_vars/sql_mode_func": true,
	// Requires log_error function
	"sys_vars/log_error_func": true,
	"sys_vars/log_error_func2": true,
	// Requires timestamp handling
	"sys_vars/timestamp_basic": true,
	// Requires ssl variable handling
	"sys_vars/ssl_capath_basic": true,
	"sys_vars/ssl_cipher_basic": true,
	// Requires report_port default formatting
	"sys_vars/report_port_basic": true,
	// Requires rpl_read_size error handling
	"sys_vars/rpl_read_size_basic": true,
	// Requires insert_id/identity to read from sessionScopeVars (not lastInsertID)
	"sys_vars/insert_id_basic": true,
	// Requires lc_messages locale index lookup
	"sys_vars/lc_messages_basic": true,
	// Requires slave_type_conversions per-element validation
	"sys_vars/slave_type_conversions_basic": true,
	// Requires sql_slave_skip_counter GTID validation
	"sys_vars/sql_slave_skip_counter_basic": true,
	// Requires SET value clamping then readback through different paths
	...
	// Requires server_id_bits specific handling
	"sys_vars/server_id_bits_basic": true,
	// Requires pseudo_thread_id to track connection ID
	"sys_vars/pseudo_thread_id_basic": true,
	// Requires specific default or SET handling
	...
	// Timeout tests - require buffer pool operations
	...
	// Timeout tests - require relay log
	...
	// "other/sp-fib":                           true, // now passes (nested BEGIN...END fix)
	"other/sp-lock":                          true,
