...
var infoSchemaColumnOrder = map[string][]string{
	...
	"innodb_metrics":           {"NAME", "SUBSYSTEM", "COUNT", "MAX_COUNT", "MIN_COUNT", "AVG_COUNT", "COUNT_RESET", "MAX_COUNT_RESET", "MIN_COUNT_RESET", "AVG_COUNT_RESET", "TIME_ENABLED", "TIME_DISABLED", "TIME_ELAPSED", "TIME_RESET", "TYPE", "STATUS", "COMMENT"},
...
func (e *Executor) infoSchemaColumns() []storage.Row {
	...
	for _, dbName := range dbNames {
		...
		for _, tblName := range tableNames {
			...
			case "DOUBLE", "REAL":
				// MySQL reports NUMERIC_PRECISION=22 for DOUBLE/REAL by default.
				// But DOUBLE(M,D) with explicit precision/scale reports M and D.
				numPrecision = int64(22)
				numScale = nil
				if idx := strings.Index(colTypeUpper, "("); idx >= 0 {
					end := strings.Index(colTypeUpper[idx:], ")")
					if end > 0 {
						inner := strings.TrimSpace(colTypeUpper[idx+1 : idx+end])
						if commaIdx := strings.Index(inner, ","); commaIdx >= 0 {
							pStr := strings.TrimSpace(inner[:commaIdx])
							sStr := strings.TrimSpace(inner[commaIdx+1:])
							if p, err := strconv.ParseInt(pStr, 10, 64); err == nil {
								if s, err2 := strconv.ParseInt(sStr, 10, 64); err2 == nil {
									numPrecision = p
									numScale = s
								}
							}
...
func (e *Executor) infoSchemaStatistics() []storage.Row {
	...
	for _, dbName := range dbNames {
		...
		sort.Strings(tableNames)
		for _, tblName := range tableNames {
			// Skip performance_schema tables: their index rows are generated by infoSchemaPerfSchemaStatistics()
	...
	rows = append(rows, infoSchemaPerfSchemaStatistics()...)
	return rows
}

// infoSchemaPerfSchemaStatistics returns static HASH index rows for performance_schema tables.
// Performance Schema tables use an in-memory HASH engine and their index metadata is fixed.
func infoSchemaPerfSchemaStatistics() []storage.Row {
	const schema = "performance_schema"
	var rows []storage.Row
	append1 := func(tbl string, nonUnique int64, idxName string, seq int64, col, nullable string) {
		rows = append(rows, storage.Row{
			"TABLE_CATALOG": "def",
			"TABLE_SCHEMA":  schema,
			"TABLE_NAME":    tbl,
	...
	append1("accounts", 0, "ACCOUNT", 1, "USER", "YES")
	append1("accounts", 0, "ACCOUNT", 2, "HOST", "YES")
	append1("cond_instances", 1, "NAME", 1, "NAME", "")
	append1("cond_instances", 0, "PRIMARY", 1, "OBJECT_INSTANCE_BEGIN", "")
	append1("data_locks", 1, "ENGINE_TRANSACTION_ID", 1, "ENGINE_TRANSACTION_ID", "YES")
	append1("data_locks", 1, "ENGINE_TRANSACTION_ID", 2, "ENGINE", "")
	append1("data_locks", 1, "OBJECT_SCHEMA", 1, "OBJECT_SCHEMA", "YES")
	append1("data_locks", 1, "OBJECT_SCHEMA", 2, "OBJECT_NAME", "YES")
	append1("data_locks", 1, "OBJECT_SCHEMA", 3, "PARTITION_NAME", "YES")
	append1("data_locks", 1, "OBJECT_SCHEMA", 4, "SUBPARTITION_NAME", "YES")
	append1("data_locks", 0, "PRIMARY", 1, "ENGINE_LOCK_ID", "")
	append1("data_locks", 0, "PRIMARY", 2, "ENGINE", "")
	append1("data_locks", 1, "THREAD_ID", 1, "THREAD_ID", "YES")
	append1("data_locks", 1, "THREAD_ID", 2, "EVENT_ID", "YES")
	append1("data_lock_waits", 1, "BLOCKING_ENGINE_LOCK_ID", 1, "BLOCKING_ENGINE_LOCK_ID", "")
	append1("data_lock_waits", 1, "BLOCKING_ENGINE_LOCK_ID", 2, "ENGINE", "")
	append1("data_lock_waits", 1, "BLOCKING_ENGINE_TRANSACTION_ID", 1, "BLOCKING_ENGINE_TRANSACTION_ID", "YES")
	append1("data_lock_waits", 1, "BLOCKING_ENGINE_TRANSACTION_ID", 2, "ENGINE", "")
	append1("data_lock_waits", 1, "BLOCKING_THREAD_ID", 1, "BLOCKING_THREAD_ID", "YES")
	append1("data_lock_waits", 1, "BLOCKING_THREAD_ID", 2, "BLOCKING_EVENT_ID", "YES")
	append1("data_lock_waits", 1, "REQUESTING_ENGINE_LOCK_ID", 1, "REQUESTING_ENGINE_LOCK_ID", "")
	append1("data_lock_waits", 1, "REQUESTING_ENGINE_LOCK_ID", 2, "ENGINE", "")
	append1("data_lock_waits", 1, "REQUESTING_ENGINE_TRANSACTION_ID", 1, "REQUESTING_ENGINE_TRANSACTION_ID", "YES")
	append1("data_lock_waits", 1, "REQUESTING_ENGINE_TRANSACTION_ID", 2, "ENGINE", "")
	append1("data_lock_waits", 1, "REQUESTING_THREAD_ID", 1, "REQUESTING_THREAD_ID", "YES")
	append1("data_lock_waits", 1, "REQUESTING_THREAD_ID", 2, "REQUESTING_EVENT_ID", "YES")
	append1("events_errors_summary_by_account_by_error", 0, "ACCOUNT", 1, "USER", "YES")
	append1("events_errors_summary_by_account_by_error", 0, "ACCOUNT", 2, "HOST", "YES")
	append1("events_errors_summary_by_account_by_error", 0, "ACCOUNT", 3, "ERROR_NUMBER", "YES")
	append1("events_errors_summary_by_host_by_error", 0, "HOST", 1, "HOST", "YES")
	append1("events_errors_summary_by_host_by_error", 0, "HOST", 2, "ERROR_NUMBER", "YES")
	append1("events_errors_summary_by_thread_by_error", 0, "THREAD_ID", 1, "THREAD_ID", "")
	append1("events_errors_summary_by_thread_by_error", 0, "THREAD_ID", 2, "ERROR_NUMBER", "YES")
	append1("events_errors_summary_by_user_by_error", 0, "USER", 1, "USER", "YES")
	append1("events_errors_summary_by_user_by_error", 0, "USER", 2, "ERROR_NUMBER", "YES")
	append1("events_errors_summary_global_by_error", 0, "ERROR_NUMBER", 1, "ERROR_NUMBER", "YES")
	append1("events_stages_current", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_stages_current", 0, "PRIMARY", 2, "EVENT_ID", "")
	append1("events_stages_history", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_stages_history", 0, "PRIMARY", 2, "EVENT_ID", "")
	append1("events_stages_summary_by_account_by_event_name", 0, "ACCOUNT", 1, "USER", "YES")
	append1("events_stages_summary_by_account_by_event_name", 0, "ACCOUNT", 2, "HOST", "YES")
	append1("events_stages_summary_by_account_by_event_name", 0, "ACCOUNT", 3, "EVENT_NAME", "")
	append1("events_stages_summary_by_host_by_event_name", 0, "HOST", 1, "HOST", "YES")
	append1("events_stages_summary_by_host_by_event_name", 0, "HOST", 2, "EVENT_NAME", "")
	append1("events_stages_summary_by_thread_by_event_name", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_stages_summary_by_thread_by_event_name", 0, "PRIMARY", 2, "EVENT_NAME", "")
	append1("events_stages_summary_by_user_by_event_name", 0, "USER", 1, "USER", "YES")
	append1("events_stages_summary_by_user_by_event_name", 0, "USER", 2, "EVENT_NAME", "")
	append1("events_stages_summary_global_by_event_name", 0, "PRIMARY", 1, "EVENT_NAME", "")
	append1("events_statements_current", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_statements_current", 0, "PRIMARY", 2, "EVENT_ID", "")
	append1("events_statements_histogram_by_digest", 0, "SCHEMA_NAME", 1, "SCHEMA_NAME", "YES")
	append1("events_statements_histogram_by_digest", 0, "SCHEMA_NAME", 2, "DIGEST", "YES")
	append1("events_statements_histogram_by_digest", 0, "SCHEMA_NAME", 3, "BUCKET_NUMBER", "")
	append1("events_statements_histogram_global", 0, "PRIMARY", 1, "BUCKET_NUMBER", "")
	append1("events_statements_history", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_statements_history", 0, "PRIMARY", 2, "EVENT_ID", "")
	append1("events_statements_summary_by_account_by_event_name", 0, "ACCOUNT", 1, "USER", "YES")
	append1("events_statements_summary_by_account_by_event_name", 0, "ACCOUNT", 2, "HOST", "YES")
	append1("events_statements_summary_by_account_by_event_name", 0, "ACCOUNT", 3, "EVENT_NAME", "")
	append1("events_statements_summary_by_digest", 0, "SCHEMA_NAME", 1, "SCHEMA_NAME", "YES")
	append1("events_statements_summary_by_digest", 0, "SCHEMA_NAME", 2, "DIGEST", "YES")
	append1("events_statements_summary_by_host_by_event_name", 0, "HOST", 1, "HOST", "YES")
	append1("events_statements_summary_by_host_by_event_name", 0, "HOST", 2, "EVENT_NAME", "")
	append1("events_statements_summary_by_program", 0, "PRIMARY", 1, "OBJECT_TYPE", "")
	append1("events_statements_summary_by_program", 0, "PRIMARY", 2, "OBJECT_SCHEMA", "")
	append1("events_statements_summary_by_program", 0, "PRIMARY", 3, "OBJECT_NAME", "")
	append1("events_statements_summary_by_thread_by_event_name", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_statements_summary_by_thread_by_event_name", 0, "PRIMARY", 2, "EVENT_NAME", "")
	append1("events_statements_summary_by_user_by_event_name", 0, "USER", 1, "USER", "YES")
	append1("events_statements_summary_by_user_by_event_name", 0, "USER", 2, "EVENT_NAME", "")
	append1("events_statements_summary_global_by_event_name", 0, "PRIMARY", 1, "EVENT_NAME", "")
	append1("events_transactions_current", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_transactions_current", 0, "PRIMARY", 2, "EVENT_ID", "")
	append1("events_transactions_history", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_transactions_history", 0, "PRIMARY", 2, "EVENT_ID", "")
	append1("events_transactions_summary_by_account_by_event_name", 0, "ACCOUNT", 1, "USER", "YES")
	append1("events_transactions_summary_by_account_by_event_name", 0, "ACCOUNT", 2, "HOST", "YES")
	append1("events_transactions_summary_by_account_by_event_name", 0, "ACCOUNT", 3, "EVENT_NAME", "")
	append1("events_transactions_summary_by_host_by_event_name", 0, "HOST", 1, "HOST", "YES")
	append1("events_transactions_summary_by_host_by_event_name", 0, "HOST", 2, "EVENT_NAME", "")
	append1("events_transactions_summary_by_thread_by_event_name", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_transactions_summary_by_thread_by_event_name", 0, "PRIMARY", 2, "EVENT_NAME", "")
	append1("events_transactions_summary_by_user_by_event_name", 0, "USER", 1, "USER", "YES")
	append1("events_transactions_summary_by_user_by_event_name", 0, "USER", 2, "EVENT_NAME", "")
	append1("events_transactions_summary_global_by_event_name", 0, "PRIMARY", 1, "EVENT_NAME", "")
	append1("events_waits_current", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_waits_current", 0, "PRIMARY", 2, "EVENT_ID", "")
	append1("events_waits_history", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_waits_history", 0, "PRIMARY", 2, "EVENT_ID", "")
	append1("events_waits_summary_by_account_by_event_name", 0, "ACCOUNT", 1, "USER", "YES")
	append1("events_waits_summary_by_account_by_event_name", 0, "ACCOUNT", 2, "HOST", "YES")
	append1("events_waits_summary_by_account_by_event_name", 0, "ACCOUNT", 3, "EVENT_NAME", "")
	append1("events_waits_summary_by_host_by_event_name", 0, "HOST", 1, "HOST", "YES")
	append1("events_waits_summary_by_host_by_event_name", 0, "HOST", 2, "EVENT_NAME", "")
	append1("events_waits_summary_by_instance", 1, "EVENT_NAME", 1, "EVENT_NAME", "")
	append1("events_waits_summary_by_instance", 0, "PRIMARY", 1, "OBJECT_INSTANCE_BEGIN", "")
	append1("events_waits_summary_by_thread_by_event_name", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("events_waits_summary_by_thread_by_event_name", 0, "PRIMARY", 2, "EVENT_NAME", "")
	append1("events_waits_summary_by_user_by_event_name", 0, "USER", 1, "USER", "YES")
	append1("events_waits_summary_by_user_by_event_name", 0, "USER", 2, "EVENT_NAME", "")
	append1("events_waits_summary_global_by_event_name", 0, "PRIMARY", 1, "EVENT_NAME", "")
	append1("file_instances", 1, "EVENT_NAME", 1, "EVENT_NAME", "")
	append1("file_instances", 0, "PRIMARY", 1, "FILE_NAME", "")
	append1("file_summary_by_event_name", 0, "PRIMARY", 1, "EVENT_NAME", "")
	append1("file_summary_by_instance", 1, "EVENT_NAME", 1, "EVENT_NAME", "")
	append1("file_summary_by_instance", 1, "FILE_NAME", 1, "FILE_NAME", "")
	append1("file_summary_by_instance", 0, "PRIMARY", 1, "OBJECT_INSTANCE_BEGIN", "")
	append1("global_status", 0, "PRIMARY", 1, "VARIABLE_NAME", "")
	append1("global_variables", 0, "PRIMARY", 1, "VARIABLE_NAME", "")
	append1("hosts", 0, "HOST", 1, "HOST", "YES")
	append1("host_cache", 1, "HOST", 1, "HOST", "YES")
	append1("host_cache", 0, "PRIMARY", 1, "IP", "")
	append1("memory_summary_by_account_by_event_name", 0, "ACCOUNT", 1, "USER", "YES")
	append1("memory_summary_by_account_by_event_name", 0, "ACCOUNT", 2, "HOST", "YES")
	append1("memory_summary_by_account_by_event_name", 0, "ACCOUNT", 3, "EVENT_NAME", "")
	append1("memory_summary_by_host_by_event_name", 0, "HOST", 1, "HOST", "YES")
	append1("memory_summary_by_host_by_event_name", 0, "HOST", 2, "EVENT_NAME", "")
	append1("memory_summary_by_thread_by_event_name", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("memory_summary_by_thread_by_event_name", 0, "PRIMARY", 2, "EVENT_NAME", "")
	append1("memory_summary_by_user_by_event_name", 0, "USER", 1, "USER", "YES")
	append1("memory_summary_by_user_by_event_name", 0, "USER", 2, "EVENT_NAME", "")
	append1("memory_summary_global_by_event_name", 0, "PRIMARY", 1, "EVENT_NAME", "")
	append1("metadata_locks", 1, "OBJECT_TYPE", 1, "OBJECT_TYPE", "")
	append1("metadata_locks", 1, "OBJECT_TYPE", 2, "OBJECT_SCHEMA", "YES")
	append1("metadata_locks", 1, "OBJECT_TYPE", 3, "OBJECT_NAME", "YES")
	append1("metadata_locks", 1, "OBJECT_TYPE", 4, "COLUMN_NAME", "YES")
	append1("metadata_locks", 1, "OWNER_THREAD_ID", 1, "OWNER_THREAD_ID", "YES")
	append1("metadata_locks", 1, "OWNER_THREAD_ID", 2, "OWNER_EVENT_ID", "YES")
	append1("metadata_locks", 0, "PRIMARY", 1, "OBJECT_INSTANCE_BEGIN", "")
	append1("mutex_instances", 1, "LOCKED_BY_THREAD_ID", 1, "LOCKED_BY_THREAD_ID", "YES")
	append1("mutex_instances", 1, "NAME", 1, "NAME", "")
	append1("mutex_instances", 0, "PRIMARY", 1, "OBJECT_INSTANCE_BEGIN", "")
	append1("objects_summary_global_by_type", 0, "OBJECT", 1, "OBJECT_TYPE", "YES")
	append1("objects_summary_global_by_type", 0, "OBJECT", 2, "OBJECT_SCHEMA", "YES")
	append1("objects_summary_global_by_type", 0, "OBJECT", 3, "OBJECT_NAME", "YES")
	append1("persisted_variables", 0, "PRIMARY", 1, "VARIABLE_NAME", "")
	append1("prepared_statements_instances", 1, "OWNER_OBJECT_TYPE", 1, "OWNER_OBJECT_TYPE", "YES")
	append1("prepared_statements_instances", 1, "OWNER_OBJECT_TYPE", 2, "OWNER_OBJECT_SCHEMA", "YES")
	append1("prepared_statements_instances", 1, "OWNER_OBJECT_TYPE", 3, "OWNER_OBJECT_NAME", "YES")
	append1("prepared_statements_instances", 0, "OWNER_THREAD_ID", 1, "OWNER_THREAD_ID", "")
	append1("prepared_statements_instances", 0, "OWNER_THREAD_ID", 2, "OWNER_EVENT_ID", "")
	append1("prepared_statements_instances", 0, "PRIMARY", 1, "OBJECT_INSTANCE_BEGIN", "")
	append1("prepared_statements_instances", 1, "STATEMENT_ID", 1, "STATEMENT_ID", "")
	append1("prepared_statements_instances", 1, "STATEMENT_NAME", 1, "STATEMENT_NAME", "YES")
	append1("replication_applier_configuration", 0, "PRIMARY", 1, "CHANNEL_NAME", "")
	append1("replication_applier_status", 0, "PRIMARY", 1, "CHANNEL_NAME", "")
	append1("replication_applier_status_by_coordinator", 0, "PRIMARY", 1, "CHANNEL_NAME", "")
	append1("replication_applier_status_by_coordinator", 1, "THREAD_ID", 1, "THREAD_ID", "YES")
	append1("replication_applier_status_by_worker", 0, "PRIMARY", 1, "CHANNEL_NAME", "")
	append1("replication_applier_status_by_worker", 0, "PRIMARY", 2, "WORKER_ID", "")
	append1("replication_applier_status_by_worker", 1, "THREAD_ID", 1, "THREAD_ID", "YES")
	append1("replication_connection_configuration", 0, "PRIMARY", 1, "CHANNEL_NAME", "")
	append1("replication_connection_status", 0, "PRIMARY", 1, "CHANNEL_NAME", "")
	append1("replication_connection_status", 1, "THREAD_ID", 1, "THREAD_ID", "YES")
	append1("rwlock_instances", 1, "NAME", 1, "NAME", "")
	append1("rwlock_instances", 0, "PRIMARY", 1, "OBJECT_INSTANCE_BEGIN", "")
	append1("rwlock_instances", 1, "WRITE_LOCKED_BY_THREAD_ID", 1, "WRITE_LOCKED_BY_THREAD_ID", "YES")
	append1("session_account_connect_attrs", 0, "PRIMARY", 1, "PROCESSLIST_ID", "")
	append1("session_account_connect_attrs", 0, "PRIMARY", 2, "ATTR_NAME", "")
	append1("session_connect_attrs", 0, "PRIMARY", 1, "PROCESSLIST_ID", "")
	append1("session_connect_attrs", 0, "PRIMARY", 2, "ATTR_NAME", "")
	append1("session_status", 0, "PRIMARY", 1, "VARIABLE_NAME", "")
	append1("session_variables", 0, "PRIMARY", 1, "VARIABLE_NAME", "")
	append1("setup_actors", 0, "PRIMARY", 1, "HOST", "")
	append1("setup_actors", 0, "PRIMARY", 2, "USER", "")
	append1("setup_actors", 0, "PRIMARY", 3, "ROLE", "")
	append1("setup_consumers", 0, "PRIMARY", 1, "NAME", "")
	append1("setup_instruments", 0, "PRIMARY", 1, "NAME", "")
	append1("setup_objects", 0, "OBJECT", 1, "OBJECT_TYPE", "")
	append1("setup_objects", 0, "OBJECT", 2, "OBJECT_SCHEMA", "YES")
	append1("setup_objects", 0, "OBJECT", 3, "OBJECT_NAME", "")
	append1("setup_threads", 0, "PRIMARY", 1, "NAME", "")
	append1("socket_instances", 1, "IP", 1, "IP", "")
	append1("socket_instances", 1, "IP", 2, "PORT", "")
	append1("socket_instances", 0, "PRIMARY", 1, "OBJECT_INSTANCE_BEGIN", "")
	append1("socket_instances", 1, "SOCKET_ID", 1, "SOCKET_ID", "")
	append1("socket_instances", 1, "THREAD_ID", 1, "THREAD_ID", "YES")
	append1("socket_summary_by_event_name", 0, "PRIMARY", 1, "EVENT_NAME", "")
	append1("socket_summary_by_instance", 1, "EVENT_NAME", 1, "EVENT_NAME", "")
	append1("socket_summary_by_instance", 0, "PRIMARY", 1, "OBJECT_INSTANCE_BEGIN", "")
	append1("status_by_account", 0, "ACCOUNT", 1, "USER", "YES")
	append1("status_by_account", 0, "ACCOUNT", 2, "HOST", "YES")
	append1("status_by_account", 0, "ACCOUNT", 3, "VARIABLE_NAME", "")
	append1("status_by_host", 0, "HOST", 1, "HOST", "YES")
	append1("status_by_host", 0, "HOST", 2, "VARIABLE_NAME", "")
	append1("status_by_thread", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("status_by_thread", 0, "PRIMARY", 2, "VARIABLE_NAME", "")
	append1("status_by_user", 0, "USER", 1, "USER", "YES")
	append1("status_by_user", 0, "USER", 2, "VARIABLE_NAME", "")
	append1("table_handles", 1, "OBJECT_TYPE", 1, "OBJECT_TYPE", "")
	append1("table_handles", 1, "OBJECT_TYPE", 2, "OBJECT_SCHEMA", "")
	append1("table_handles", 1, "OBJECT_TYPE", 3, "OBJECT_NAME", "")
	append1("table_handles", 1, "OWNER_THREAD_ID", 1, "OWNER_THREAD_ID", "YES")
	append1("table_handles", 1, "OWNER_THREAD_ID", 2, "OWNER_EVENT_ID", "YES")
	append1("table_handles", 0, "PRIMARY", 1, "OBJECT_INSTANCE_BEGIN", "")
	append1("table_io_waits_summary_by_index_usage", 0, "OBJECT", 1, "OBJECT_TYPE", "YES")
	append1("table_io_waits_summary_by_index_usage", 0, "OBJECT", 2, "OBJECT_SCHEMA", "YES")
	append1("table_io_waits_summary_by_index_usage", 0, "OBJECT", 3, "OBJECT_NAME", "YES")
	append1("table_io_waits_summary_by_index_usage", 0, "OBJECT", 4, "INDEX_NAME", "YES")
	append1("table_io_waits_summary_by_table", 0, "OBJECT", 1, "OBJECT_TYPE", "YES")
	append1("table_io_waits_summary_by_table", 0, "OBJECT", 2, "OBJECT_SCHEMA", "YES")
	append1("table_io_waits_summary_by_table", 0, "OBJECT", 3, "OBJECT_NAME", "YES")
	append1("table_lock_waits_summary_by_table", 0, "OBJECT", 1, "OBJECT_TYPE", "YES")
	append1("table_lock_waits_summary_by_table", 0, "OBJECT", 2, "OBJECT_SCHEMA", "YES")
	append1("table_lock_waits_summary_by_table", 0, "OBJECT", 3, "OBJECT_NAME", "YES")
	append1("threads", 1, "NAME", 1, "NAME", "")
	append1("threads", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("threads", 1, "PROCESSLIST_ACCOUNT", 1, "PROCESSLIST_USER", "YES")
	append1("threads", 1, "PROCESSLIST_ACCOUNT", 2, "PROCESSLIST_HOST", "YES")
	append1("threads", 1, "PROCESSLIST_HOST", 1, "PROCESSLIST_HOST", "YES")
	append1("threads", 1, "PROCESSLIST_ID", 1, "PROCESSLIST_ID", "YES")
	append1("threads", 1, "RESOURCE_GROUP", 1, "RESOURCE_GROUP", "YES")
	append1("threads", 1, "THREAD_OS_ID", 1, "THREAD_OS_ID", "YES")
	append1("users", 0, "USER", 1, "USER", "YES")
	append1("user_defined_functions", 0, "PRIMARY", 1, "UDF_NAME", "")
	append1("user_variables_by_thread", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("user_variables_by_thread", 0, "PRIMARY", 2, "VARIABLE_NAME", "")
	append1("variables_by_thread", 0, "PRIMARY", 1, "THREAD_ID", "")
	append1("variables_by_thread", 0, "PRIMARY", 2, "VARIABLE_NAME", "")
	return rows
}
...
func (e *Executor) perfSchemaESMSByDigest() []storage.Row {
	...
	for _, d := range e.psDigests {
		...
		rows = append(rows, storage.Row{
			...
			"MAX_TIMER_WAIT":               int64(0),
			"SUM_LOCK_TIME":                int64(0),
			"SUM_ERRORS":                   d.SumErrors,
			"SUM_WARNINGS":                 d.SumWarnings,
			"SUM_ROWS_AFFECTED":            d.SumRowsAffected,
			"SUM_ROWS_SENT":                int64(0),
			"SUM_ROWS_EXAMINED":            int64(0),
			"SUM_CREATED_TMP_DISK_TABLES":  int64(0),
			"SUM_CREATED_TMP_TABLES":       int64(0),
